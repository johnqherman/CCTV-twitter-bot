...
while True:
        ...
        city_country = city_country[11:].strip().replace(", Province Of", "").replace(", Republic Of", "") # pretty up text and remove "province/republic of" text from the end of the string (if it exists)
        tweet = city_country
